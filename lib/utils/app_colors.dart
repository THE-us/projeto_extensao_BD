...
class AppColors {
  ...
  static const Color statusOpen = Color(0xFF4DB6AC); // Verde/Azul claro para "Aberto"
  
  // Navegação
  static const Color navSelected = Color(0xFFD67D55); // O tom alaranjado/marrom do ícone ativo
